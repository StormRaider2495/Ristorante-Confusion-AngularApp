...
angular.module('confusionApp')
    ...
    .controller('HomeController', ['$scope', 'menuFactory', 'promoFactory', 'corporateFactory', function($scope, menuFactory, promoFactory, corporateFactory) {
        $scope.dish = menuFactory.getDish(0);
        $scope.leader = corporateFactory.getLeader(0);
        $scope.promo = promoFactory.getPromo();
    }])
